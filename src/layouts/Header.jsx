          ...
          <div class="d-flex">
            <div class="navbar-brand-box horizontal-logo">
              <a class="logo logo-dark">
                ...
                {/* <h5 className="text-primary">Clickle</h5> */}
                <span class="logo-lg">
                  <img src="/images/clickle/logo.png" alt="" height="60" />
                </span>
              </a>
          ...
          <div class="d-flex align-items-center">
            <div class="dropdown ms-sm-3 header-item topbar-user">
              ...
              >
                <span class="d-flex align-items-center">
                  ...
                  <span class="text-start ms-xl-2">
                    <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text text-primary">
                      Clickle Admin
                    </span>
              ...
              <div class="dropdown-menu dropdown-menu-end">
                <h6 class="dropdown-header" style={{ color: '#dcdcdcde' }}>Welcome Clickle Admin</h6>
                <a
